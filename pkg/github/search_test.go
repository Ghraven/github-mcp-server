...
func Test_SearchRepositories(t *testing.T) {
	...
	tool, _ := SearchRepositories(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, handler := SearchRepositories(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_SearchCode(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := SearchCode(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := SearchCode(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_SearchUsers(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := SearchUsers(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := SearchUsers(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
