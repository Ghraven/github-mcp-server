...
func Test_GetMe(t *testing.T) {
	...
	tool, _ := GetMe(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, handler := GetMe(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
