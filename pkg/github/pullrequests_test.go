...
func Test_GetPullRequest(t *testing.T) {
	...
	tool, _ := GetPullRequest(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, handler := GetPullRequest(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_ListPullRequests(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := ListPullRequests(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := ListPullRequests(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_MergePullRequest(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := MergePullRequest(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := MergePullRequest(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_GetPullRequestFiles(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := GetPullRequestFiles(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := GetPullRequestFiles(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_GetPullRequestStatus(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := GetPullRequestStatus(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := GetPullRequestStatus(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_UpdatePullRequestBranch(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := UpdatePullRequestBranch(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := UpdatePullRequestBranch(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_GetPullRequestComments(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := GetPullRequestComments(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := GetPullRequestComments(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_GetPullRequestReviews(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := GetPullRequestReviews(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := GetPullRequestReviews(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_CreatePullRequestReview(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := CreatePullRequestReview(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := CreatePullRequestReview(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_CreatePullRequest(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := CreatePullRequest(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := CreatePullRequest(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
