...
func Test_GetFileContents(t *testing.T) {
	...
	tool, _ := GetFileContents(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, handler := GetFileContents(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_ForkRepository(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := ForkRepository(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := ForkRepository(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_CreateBranch(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := CreateBranch(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := CreateBranch(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_ListCommits(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := ListCommits(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := ListCommits(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_CreateOrUpdateFile(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := CreateOrUpdateFile(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := CreateOrUpdateFile(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_CreateRepository(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := CreateRepository(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := CreateRepository(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
...
func Test_PushFiles(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := PushFiles(func(_ context.Context) *github.Client { return mockClient }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := PushFiles(func(_ context.Context) *github.Client { return client }, translations.NullTranslationHelper)
